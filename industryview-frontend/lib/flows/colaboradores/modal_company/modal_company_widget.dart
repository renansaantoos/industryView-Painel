...
import 'modal_company_model.dart';
export 'modal_company_model.dart';

class ModalCompanyWidget extends StatefulWidget {
  const ModalCompanyWidget({super.key});

  @override
  State<ModalCompanyWidget> createState() => _ModalCompanyWidgetState();
}

class _ModalCompanyWidgetState extends State<ModalCompanyWidget> {
  late ModalCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCompanyModel());
    ...
    return Align(
      ...
      child: Padding(
        ...
        child: FutureBuilder<ApiCallResponse>(
          future: _model
              .company(
            requestFn: () => UserGroup.getCompanyCall.call(
          ...
          builder: (context, snapshot) {
            ...
            final containerGetCompanyResponse = snapshot.data!;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SelectionArea(
                                      child: Text(
                                    FFLocalizations.of(context).getText(
                                      '68u8v30v' /* Acompanhe todas as informações... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelSmall
                                        .override(
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text: UserGroup.getCompanyCall
                                              .brandname(
                                            containerGetCompanyResponse
                                                .jsonBody,
                                          ),
                                        ),
                                        focusNode: _model.nameFantasiaFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              ...
                                              TextEditingController(
                                            text:
                                                UserGroup.getCompanyCall.email(
                                              containerGetCompanyResponse
                                                  .jsonBody,
                                            ),
                                          ),
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.editCompany = await UserGroup
                                          ...
                                          token: FFAppState().token,
                                          brandName: _model
                                              .nameFantasiaTextController.text,
                                          legalName: _model
                                              .razaoSocialTextController.text,
                                          cnpj: _model.cnpjTextController.text,
                                          phone: _model
                                              .phoneEmpresaTextController.text,
                                          email: _model
                                              .emailEmpresaTextController.text,
