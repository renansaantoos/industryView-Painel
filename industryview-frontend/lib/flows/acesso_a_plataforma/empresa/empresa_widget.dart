...
class EmpresaWidget extends StatefulWidget {
  ...
  static String routeName = 'Empresa';
  static String routePath = '/empresa';
                                          ...
                                          Flexible(
                                            child: Padding(
                                              ...
                                              child: SelectionArea(
                                                ...
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'zlsomx5t' /* Finalize o cadastro da Empresa... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .titleLarge
                                      ...
                                      Padding(
                                        ...
                                        child: SelectionArea(
                                          ...
                                          FFLocalizations.of(context).getText(
                                            'zvsmhiya' /* Preencha todos os dados da emp... */,
                                          ),
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              _model.creatCompany =
                                                ...
                                                state: _model
                                                    .ufTextController.text,
                                              );

                                              _shouldSetState = true;
                                              if ((_model.creatCompany
                                                      ?.succeeded ??
                                                  true)) {
                                                // Extract company ID from response
                                                final companyId = getJsonField(
                                                  (_model.creatCompany
                                                          ?.jsonBody ??
                                                      ''),
                                                  r'''$.id''',
                                                ...
                                                // Update FFAppState with the new company ID
                                                FFAppState()
                                                    .updateInfoUserStruct(
                                                  (e) => e
                                                    ..companyId = companyId,
                                                );
                                                FFAppState().update(() {});
