...
class LightModeTheme extends AppTheme {
  ...
  late Color secondary = const Color(0xFFECF5FF);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF2D323F);
  late Color secondaryText = const Color(0xFF76787D);
  late Color primaryBackground = const Color(0xFFFAFAFA);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x90011741);
  ...
  late Color success = const Color(0xFF028F58);
  late Color warning = const Color(0xFFC96F46);
  late Color error = const Color(0xFFE65454);
  late Color info = const Color(0xFFFFFFFF);

  late Color darkBackground = const Color(0xFF011741);
  late Color status06 = const Color(0xFFFCF5EF);
  late Color status03 = const Color(0xFFF0F3FC);
  late Color status04 = const Color(0xFFF4FEF9);
  late Color status02 = const Color(0xFFFBF9F6);
  late Color status01 = const Color(0xFFFAE2E3);
}
