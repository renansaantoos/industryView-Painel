...
class AppStateNotifier extends ChangeNotifier {
  ...
  IndustryViewAuthUser? initialUser;
  IndustryViewAuthUser? user;
  ...
  void update(IndustryViewAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        AppRoute(
          ...
          path: Rdo2Widget.routePath,
          requireAuth: true,
          builder: (context, params) => Rdo2Widget(
        ...
        AppRoute(
          name: DetalhesDaTarefaWidget.routeName,
          path: DetalhesDaTarefaWidget.routePath,
          requireAuth: true,
          builder: (context, params) => DetalhesDaTarefaWidget(
            item: params.getParam(
              'item',
              ParamType.JSON,
            ),
        ...
        AppRoute(
          name: PageCheckQrcodeWidget.routeName,
          path: PageCheckQrcodeWidget.routePath,
          requireAuth: true,
        ...
        AppRoute(
          name: ProjectSelectionWidget.routeName,
          path: ProjectSelectionWidget.routePath,
          requireAuth: true,
          builder: (context, params) {
            final extra = params.state.extraMap;
