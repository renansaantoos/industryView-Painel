...
/// Converte data da sprint (ISO 8601 string ou Unix timestamp int) para milliseconds since epoch.
int? parseDateToMillis(dynamic value) {
...
dynamic getJsonField(
  ...
  if (response == null) {
    ...
    if (jsonPath.contains('pageTotal')) {
      return 0;
    }
    return null;
  }
