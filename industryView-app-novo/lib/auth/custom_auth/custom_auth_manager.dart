...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    industryViewAuthUserSubject.add(
      IndustryViewAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<IndustryViewAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  IndustryViewAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    industryViewAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
IndustryViewAuthUser? currentUser;
