...
import '../../services/offline_api_wrapper.dart';
...
class ApiManager {
  ...
  static Future<ApiCallResponse> urlRequest(
    ...
    final response = await makeRequest(
      ...
      onTimeout: () {
        throw TimeoutException('A requisição excedeu o tempo limite de 30 segundos');
      },
    );
  ...
  Future<ApiCallResponse> makeApiCall({
    ...
    bool useOfflineWrapper = true,
    ApiCallOptions? options,
    http.Client? client,
  }) async {
    if (useOfflineWrapper) {
      return OfflineApiWrapper.instance.call(
        callName: callName,
        apiUrl: apiUrl,
        callType: callType,
        headers: headers,
    ...
    try {
      ...
      result = ApiCallResponse({}, {}, 503, exception: e);
    }
